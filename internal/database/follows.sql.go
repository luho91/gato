...
SELECT filtered_feed_follows.id, filtered_feed_follows.created_at, filtered_feed_follows.updated_at, filtered_feed_follows.user_id, filtered_feed_follows.feed_id, feeds.name AS feed_name, users.name AS user_name
